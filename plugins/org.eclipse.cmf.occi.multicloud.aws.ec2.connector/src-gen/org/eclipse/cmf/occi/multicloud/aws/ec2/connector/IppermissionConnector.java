 ...
 * http://occiware.org/occi/infrastructure/aws# - term: ippermission - title:
 */
public class IppermissionConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.IppermissionImpl {
	/**
	...
	// Start of user code IppermissionConnector
	/**
	 * Constructs a instanceec2 connector.
	 */
	IppermissionConnector() {
		LOGGER.debug("Constructor called on " + this);
		System.out.println("Ippermission constructor called ==> " + this);
	}
	// End of user code
