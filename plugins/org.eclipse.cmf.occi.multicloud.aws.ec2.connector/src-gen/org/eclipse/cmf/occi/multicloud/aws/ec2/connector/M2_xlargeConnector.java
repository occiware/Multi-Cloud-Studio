 ...
 * - title: 
 */
public class M2_xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.M2_xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(M2_xlargeConnector.class);

	// Start of user code M2_xlargeconnector_constructor
	/**
	 * Constructs a m2_xlarge connector.
	 */
	M2_xlargeConnector()
	{
