...
/**
 * This is the item provider adapter for a {@link org.eclipse.cmf.occi.multicloud.aws.ec2.Keypair} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class KeypairItemProvider extends ResourceItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addFingerPrintPropertyDescriptor(object);
			addEncodedPublicKeyPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Ec2Package.eINSTANCE.getKeypair_Name(),
				 true,
				 false,
				 false,
	...
	protected void addPrivateKeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Keypair_privateKey_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Keypair_privateKey_feature", "_UI_Keypair_type"),
				 Ec2Package.eINSTANCE.getKeypair_PrivateKey(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Finger Print feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFingerPrintPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Keypair_fingerPrint_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Keypair_fingerPrint_feature", "_UI_Keypair_type"),
				 Ec2Package.eINSTANCE.getKeypair_FingerPrint(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Encoded Public Key feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addEncodedPublicKeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Keypair_encodedPublicKey_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Keypair_encodedPublicKey_feature", "_UI_Keypair_type"),
				 Ec2Package.eINSTANCE.getKeypair_EncodedPublicKey(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
