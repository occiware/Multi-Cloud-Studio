...
public class RegionlinkImpl extends LinkImpl implements Regionlink {
	...
	public boolean sourceConstraint(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, RegionsTables.STR_Regionlink_c_c_sourceConstraint);
		...
		if (le) {
			...
			final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_regions_c_c_Region = idResolver.getClass(RegionsTables.CLSSid_Region, null);
			final /*@NonInvalid*/ Resource source = this.getSource();
			final /*@NonInvalid*/ boolean result = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, source, TYP_regions_c_c_Region).booleanValue();
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, RegionsTables.STR_Regionlink_c_c_sourceConstraint, this, (Object)null, diagnostics, context, (Object)null, severity_0, result, RegionsTables.INT_0).booleanValue();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case RegionsPackage.REGIONLINK___SOURCE_CONSTRAINT__DIAGNOSTICCHAIN_MAP:
