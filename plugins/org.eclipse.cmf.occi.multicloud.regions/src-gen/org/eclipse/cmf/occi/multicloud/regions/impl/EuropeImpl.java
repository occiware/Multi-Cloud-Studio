 ...
 * @generated
 */
public class EuropeImpl extends RegionImpl implements Europe {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Region.class) {
			switch (baseOperationID) {
				case RegionsPackage.REGION___APPLIES_CONSTRAINT__DIAGNOSTICCHAIN_MAP: return RegionsPackage.EUROPE___APPLIES_CONSTRAINT__DIAGNOSTICCHAIN_MAP;
