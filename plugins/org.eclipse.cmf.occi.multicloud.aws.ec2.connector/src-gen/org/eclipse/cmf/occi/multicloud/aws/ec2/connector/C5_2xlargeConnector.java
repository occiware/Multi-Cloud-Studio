 ...
 * - title: 
 */
public class C5_2xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.C5_2xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(C5_2xlargeConnector.class);

	// Start of user code C5_2xlargeconnector_constructor
	/**
	 * Constructs a c5_2xlarge connector.
	 */
	C5_2xlargeConnector()
	{
