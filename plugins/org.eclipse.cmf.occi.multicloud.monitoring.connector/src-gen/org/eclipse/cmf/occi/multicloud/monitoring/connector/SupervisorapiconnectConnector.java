 ...
 * - title: 
 */
public class SupervisorapiconnectConnector extends SupervisorapiconnectImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(SupervisorapiconnectConnector.class);

	// Start of user code Supervisorapiconnectconnector_constructor
	/**
	 * Constructs a supervisorapiconnect connector.
	 */
	SupervisorapiconnectConnector()
	{
