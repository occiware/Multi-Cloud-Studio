 ...
 * - title: 
 */
public class I2_2xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.I2_2xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(I2_2xlargeConnector.class);

	// Start of user code I2_2xlargeconnector_constructor
	/**
	 * Constructs a i2_2xlarge connector.
	 */
	I2_2xlargeConnector()
	{
