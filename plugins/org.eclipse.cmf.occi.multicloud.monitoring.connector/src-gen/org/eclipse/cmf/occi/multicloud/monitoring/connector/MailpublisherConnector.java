...
import cloudmonitoring.impl.MailpublisherImpl;
 ...
 */
public class MailpublisherConnector extends MailpublisherImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(MailpublisherConnector.class);

	// Start of user code Mailpublisherconnector_constructor
	/**
	 * Constructs a mailpublisher connector.
	 */
	MailpublisherConnector()
	{
