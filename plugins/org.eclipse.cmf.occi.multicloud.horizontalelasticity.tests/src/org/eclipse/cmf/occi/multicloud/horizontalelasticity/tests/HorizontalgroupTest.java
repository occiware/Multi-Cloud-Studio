...
public class HorizontalgroupTest extends TestCase {
	...
	/**
	 * The fixture for this Horizontalgroup test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected Horizontalgroup fixture = null;
	...
	public static void main(String[] args) {
		TestRunner.run(HorizontalgroupTest.class);
	}

	/**
	 * Constructs a new Horizontalgroup test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public HorizontalgroupTest(String name) {
		super(name);
	}

	/**
	 * Sets the fixture for this Horizontalgroup test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void setFixture(Horizontalgroup fixture) {
		this.fixture = fixture;
	}

	/**
	 * Returns the fixture for this Horizontalgroup test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected Horizontalgroup getFixture() {
		return fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(HorizontalelasticityFactory.eINSTANCE.createHorizontalgroup());
	}
