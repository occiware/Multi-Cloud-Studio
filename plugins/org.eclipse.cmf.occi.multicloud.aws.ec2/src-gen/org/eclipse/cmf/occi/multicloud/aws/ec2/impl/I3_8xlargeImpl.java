...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>I3 8xlarge</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.I3_8xlargeImpl#getOcciComputeMemory <em>Occi Compute Memory</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.I3_8xlargeImpl#getInstanceType <em>Instance Type</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.I3_8xlargeImpl#getOcciComputeCores <em>Occi Compute Cores</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.I3_8xlargeImpl#getOcciComputeEphemeralStorageSize <em>Occi Compute Ephemeral Storage Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class I3_8xlargeImpl extends StorageoptimizedImpl implements I3_8xlarge {
	/**
	 ...
	 * @ordered
	 */
	protected static final String INSTANCE_TYPE_EDEFAULT = "i3.8xlarge";
	 ...
	 * @ordered
	 */
	protected static final Float OCCI_COMPUTE_EPHEMERAL_STORAGE_SIZE_EDEFAULT = new Float(7600.0F);
	...
	protected EClass eStaticClass() {
		return Ec2Package.eINSTANCE.getI3_8xlarge();
	}
	...
	public void setOcciComputeMemory(Float newOcciComputeMemory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.I3_8XLARGE__OCCI_COMPUTE_MEMORY, oldOcciComputeMemory, occiComputeMemory));
	}
	...
	public void setInstanceType(String newInstanceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.I3_8XLARGE__INSTANCE_TYPE, oldInstanceType, instanceType));
	}
	...
	public void setOcciComputeCores(Integer newOcciComputeCores) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.I3_8XLARGE__OCCI_COMPUTE_CORES, oldOcciComputeCores, occiComputeCores));
	}
	...
	public void setOcciComputeEphemeralStorageSize(Float newOcciComputeEphemeralStorageSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.I3_8XLARGE__OCCI_COMPUTE_EPHEMERAL_STORAGE_SIZE, oldOcciComputeEphemeralStorageSize, occiComputeEphemeralStorageSize));
	}
