 ...
 * - title: 
 */
public class M3_largeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.M3_largeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(M3_largeConnector.class);

	// Start of user code M3_largeconnector_constructor
	/**
	 * Constructs a m3_large connector.
	 */
	M3_largeConnector()
	{
