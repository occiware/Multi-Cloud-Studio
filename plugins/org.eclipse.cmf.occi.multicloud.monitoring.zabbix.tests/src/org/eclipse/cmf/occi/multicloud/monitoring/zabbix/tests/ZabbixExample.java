...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>zabbix</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ZabbixExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ZabbixPackage.eNS_URI, 
			 ZabbixPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.zabbix"));
				Zabbixcollector root = ZabbixFactory.eINSTANCE.createZabbixcollector();
