...
/**
 * This is the item provider adapter for a {@link cloudmonitoring.Emfpublisher} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EmfpublisherItemProvider extends MixinBaseItemProvider {
	/**
	 ...
	 * @generated
	 */
	public EmfpublisherItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Emfpublisher"));
	}
	...
	public String getText(Object object) {
		MonitorState labelValue = ((Emfpublisher)object).getPublisherState();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_Emfpublisher_type") :
			getString("_UI_Emfpublisher_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Emfpublisher.class)) {
