 ...
 * - title: 
 */
public class M3_xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.M3_xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(M3_xlargeConnector.class);

	// Start of user code M3_xlargeconnector_constructor
	/**
	 * Constructs a m3_xlarge connector.
	 */
	M3_xlargeConnector()
	{
