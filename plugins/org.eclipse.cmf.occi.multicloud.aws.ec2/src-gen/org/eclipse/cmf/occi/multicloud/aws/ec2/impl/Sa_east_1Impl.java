...
import org.eclipse.cmf.occi.multicloud.aws.ec2.Sa_east_1;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.Sa_east_1Impl#getCountry <em>Country</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.Sa_east_1Impl#getRegionName <em>Region Name</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.Sa_east_1Impl#getRegionId <em>Region Id</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.Sa_east_1Impl#getCity <em>City</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Sa_east_1Impl extends MixinBaseImpl implements Sa_east_1 {
	/**
	...
	protected EClass eStaticClass() {
		return Ec2Package.eINSTANCE.getSa_east_1();
	}
	...
	public void setCountry(String newCountry) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.SA_EAST_1__COUNTRY, oldCountry, country));
	}
	...
	public void setRegionName(String newRegionName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.SA_EAST_1__REGION_NAME, oldRegionName, regionName));
	}
	...
	public void setRegionId(String newRegionId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.SA_EAST_1__REGION_ID, oldRegionId, regionId));
	}
	...
	public void setCity(String newCity) {
		...
		city = newCity;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.SA_EAST_1__CITY, oldCity, city));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ec2Package.SA_EAST_1__COUNTRY:
				return getCountry();
			case Ec2Package.SA_EAST_1__REGION_NAME:
				return getRegionName();
			case Ec2Package.SA_EAST_1__REGION_ID:
				return getRegionId();
			case Ec2Package.SA_EAST_1__CITY:
				return getCity();
		}
