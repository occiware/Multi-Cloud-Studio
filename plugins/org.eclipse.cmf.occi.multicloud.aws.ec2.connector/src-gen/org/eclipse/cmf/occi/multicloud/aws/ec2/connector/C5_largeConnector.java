 ...
 * - title: 
 */
public class C5_largeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.C5_largeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(C5_largeConnector.class);

	// Start of user code C5_largeconnector_constructor
	/**
	 * Constructs a c5_large connector.
	 */
	C5_largeConnector()
	{
