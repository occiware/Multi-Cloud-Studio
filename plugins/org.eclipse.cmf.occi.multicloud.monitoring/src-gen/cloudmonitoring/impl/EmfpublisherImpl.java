...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Emfpublisher</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link cloudmonitoring.impl.EmfpublisherImpl#getPublisherState <em>Publisher State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EmfpublisherImpl extends MixinBaseImpl implements Emfpublisher {
	/**
	...
	protected EClass eStaticClass() {
		return CloudmonitoringPackage.Literals.EMFPUBLISHER;
	}
	...
	public void setPublisherState(MonitorState newPublisherState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CloudmonitoringPackage.EMFPUBLISHER__PUBLISHER_STATE, oldPublisherState, publisherState));
	}
	...
	public boolean appliesConstraint(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		 ...
		 *   let severity : Integer[1] = 'Emfpublisher::appliesConstraint'.getSeverity()
		 *   in
		 *     if severity <= 0
		 *     then true
		 *     else
		 ...
		 *       in
		 *         'Emfpublisher::appliesConstraint'.logDiagnostic(self, null, diagnostics, context, null, severity, result, 0)
		 *     endif
		 */
		final /*@NonInvalid*/ Executor executor = PivotUtilInternal.getExecutor(this);
		final /*@NonInvalid*/ IdResolver idResolver = executor.getIdResolver();
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, CloudmonitoringTables.STR_Emfpublisher_c_c_appliesConstraint);
		...
		if (le) {
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, CloudmonitoringTables.STR_Emfpublisher_c_c_appliesConstraint, this, (Object)null, diagnostics, context, (Object)null, severity_0, result, CloudmonitoringTables.INT_0).booleanValue();
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CloudmonitoringPackage.EMFPUBLISHER__PUBLISHER_STATE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Publishercontrol.class) {
			switch (derivedFeatureID) {
				case CloudmonitoringPackage.EMFPUBLISHER__PUBLISHER_STATE: return CloudmonitoringPackage.PUBLISHERCONTROL__PUBLISHER_STATE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Publishercontrol.class) {
			switch (baseFeatureID) {
				case CloudmonitoringPackage.PUBLISHERCONTROL__PUBLISHER_STATE: return CloudmonitoringPackage.EMFPUBLISHER__PUBLISHER_STATE;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == Publishercontrol.class) {
			switch (baseOperationID) {
				case CloudmonitoringPackage.PUBLISHERCONTROL___ENABLE: return CloudmonitoringPackage.EMFPUBLISHER___ENABLE;
				case CloudmonitoringPackage.PUBLISHERCONTROL___DISABLE: return CloudmonitoringPackage.EMFPUBLISHER___DISABLE;
				case CloudmonitoringPackage.PUBLISHERCONTROL___APPLIES_CONSTRAINT__DIAGNOSTICCHAIN_MAP: return CloudmonitoringPackage.EMFPUBLISHER___APPLIES_CONSTRAINT__DIAGNOSTICCHAIN_MAP;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case CloudmonitoringPackage.EMFPUBLISHER___APPLIES_CONSTRAINT__DIAGNOSTICCHAIN_MAP:
				return appliesConstraint((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case CloudmonitoringPackage.EMFPUBLISHER___ENABLE:
				enable();
				return null;
			case CloudmonitoringPackage.EMFPUBLISHER___DISABLE:
				disable();
				return null;
		}
