 ...
 * - title: 
 */
public class C4_largeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.C4_largeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(C4_largeConnector.class);

	// Start of user code C4_largeconnector_constructor
	/**
	 * Constructs a c4_large connector.
	 */
	C4_largeConnector()
	{
