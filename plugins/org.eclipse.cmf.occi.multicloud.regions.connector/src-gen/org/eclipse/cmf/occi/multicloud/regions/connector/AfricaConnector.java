 ...
 * - title: 
 */
public class AfricaConnector extends org.eclipse.cmf.occi.multicloud.regions.impl.AfricaImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(AfricaConnector.class);

	// Start of user code Africaconnector_constructor
	/**
	 * Constructs a africa connector.
	 */
	AfricaConnector()
	{
