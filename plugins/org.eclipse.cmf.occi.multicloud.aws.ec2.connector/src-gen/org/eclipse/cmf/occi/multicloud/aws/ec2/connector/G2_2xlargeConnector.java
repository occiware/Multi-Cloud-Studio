 ...
 * - title: 
 */
public class G2_2xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.G2_2xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(G2_2xlargeConnector.class);

	// Start of user code G2_2xlargeconnector_constructor
	/**
	 * Constructs a g2_2xlarge connector.
	 */
	G2_2xlargeConnector()
	{
