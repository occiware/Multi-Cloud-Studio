 ...
 * - title: 
 */
public class C4_xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.C4_xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(C4_xlargeConnector.class);

	// Start of user code C4_xlargeconnector_constructor
	/**
	 * Constructs a c4_xlarge connector.
	 */
	C4_xlargeConnector()
	{
