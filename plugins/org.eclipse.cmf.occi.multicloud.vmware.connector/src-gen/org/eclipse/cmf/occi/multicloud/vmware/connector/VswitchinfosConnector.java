 ...
 */
public class VswitchinfosConnector extends org.eclipse.cmf.occi.multicloud.vmware.impl.VswitchinfosImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(VswitchinfosConnector.class);

	// Start of user code Vswitchinfosconnector_constructor
	/**
	 * Constructs a vswitchinfos connector.
	 */
	VswitchinfosConnector()
	{
