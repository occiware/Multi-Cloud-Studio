...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>G3 16xlarge</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.G3_16xlargeImpl#getOcciComputeMemory <em>Occi Compute Memory</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.G3_16xlargeImpl#getInstanceType <em>Instance Type</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.G3_16xlargeImpl#getOcciComputeCores <em>Occi Compute Cores</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.G3_16xlargeImpl#getGpus <em>Gpus</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.G3_16xlargeImpl#getGpuMemory <em>Gpu Memory</em>}</li>
 * </ul>
 *
 * @generated
 */
public class G3_16xlargeImpl extends AcceleratedcomputingImpl implements G3_16xlarge {
	/**
	 ...
	 * @ordered
	 */
	protected static final String INSTANCE_TYPE_EDEFAULT = "g3.16xlarge";
	...
	protected EClass eStaticClass() {
		return Ec2Package.eINSTANCE.getG3_16xlarge();
	}
	...
	public void setOcciComputeMemory(Float newOcciComputeMemory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.G3_16XLARGE__OCCI_COMPUTE_MEMORY, oldOcciComputeMemory, occiComputeMemory));
	}
	...
	public void setInstanceType(String newInstanceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.G3_16XLARGE__INSTANCE_TYPE, oldInstanceType, instanceType));
	}
	...
	public void setOcciComputeCores(Integer newOcciComputeCores) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.G3_16XLARGE__OCCI_COMPUTE_CORES, oldOcciComputeCores, occiComputeCores));
	}
	...
	public void setGpus(Integer newGpus) {
		...
		gpus = newGpus;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.G3_16XLARGE__GPUS, oldGpus, gpus));
	}
	...
	public void setGpuMemory(Float newGpuMemory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.G3_16XLARGE__GPU_MEMORY, oldGpuMemory, gpuMemory));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ec2Package.G3_16XLARGE__OCCI_COMPUTE_MEMORY:
				return getOcciComputeMemory();
			case Ec2Package.G3_16XLARGE__INSTANCE_TYPE:
				return getInstanceType();
			case Ec2Package.G3_16XLARGE__OCCI_COMPUTE_CORES:
				return getOcciComputeCores();
			case Ec2Package.G3_16XLARGE__GPUS:
				return getGpus();
			case Ec2Package.G3_16XLARGE__GPU_MEMORY:
				return getGpuMemory();
		}
