 ...
 * - title: 
 */
public class C1_xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.C1_xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(C1_xlargeConnector.class);

	// Start of user code C1_xlargeconnector_constructor
	/**
	 * Constructs a c1_xlarge connector.
	 */
	C1_xlargeConnector()
	{
