 ...
 * - title: 
 */
public class C5_4xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.C5_4xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(C5_4xlargeConnector.class);

	// Start of user code C5_4xlargeconnector_constructor
	/**
	 * Constructs a c5_4xlarge connector.
	 */
	C5_4xlargeConnector()
	{
