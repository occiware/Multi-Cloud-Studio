 ...
 * - title: 
 */
public class H1_8xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.H1_8xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(H1_8xlargeConnector.class);

	// Start of user code H1_8xlargeconnector_constructor
	/**
	 * Constructs a h1_8xlarge connector.
	 */
	H1_8xlargeConnector()
	{
