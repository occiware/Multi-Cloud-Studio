 ...
 * - title: 
 */
public class M2_2xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.M2_2xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(M2_2xlargeConnector.class);

	// Start of user code M2_2xlargeconnector_constructor
	/**
	 * Constructs a m2_2xlarge connector.
	 */
	M2_2xlargeConnector()
	{
