...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Publishercontrol</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link cloudmonitoring.impl.PublishercontrolImpl#getPublisherState <em>Publisher State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PublishercontrolImpl extends PublisherImpl implements Publishercontrol {
	 ...
	 * @generated
	 */
	protected PublishercontrolImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CloudmonitoringPackage.Literals.PUBLISHERCONTROL;
	}
	...
	public void setPublisherState(MonitorState newPublisherState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CloudmonitoringPackage.PUBLISHERCONTROL__PUBLISHER_STATE, oldPublisherState, publisherState));
	}
	...
	public boolean appliesConstraint(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, CloudmonitoringTables.STR_Publishercontrol_c_c_appliesConstraint);
		...
		if (le) {
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, CloudmonitoringTables.STR_Publishercontrol_c_c_appliesConstraint, this, (Object)null, diagnostics, context, (Object)null, severity_0, result, CloudmonitoringTables.INT_0).booleanValue();
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CloudmonitoringPackage.PUBLISHERCONTROL__PUBLISHER_STATE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case CloudmonitoringPackage.PUBLISHERCONTROL___ENABLE:
				enable();
				return null;
			case CloudmonitoringPackage.PUBLISHERCONTROL___DISABLE:
				disable();
				return null;
			case CloudmonitoringPackage.PUBLISHERCONTROL___APPLIES_CONSTRAINT__DIAGNOSTICCHAIN_MAP:
