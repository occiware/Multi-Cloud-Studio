 ...
 * - title: 
 */
public class C3_xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.C3_xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(C3_xlargeConnector.class);

	// Start of user code C3_xlargeconnector_constructor
	/**
	 * Constructs a c3_xlarge connector.
	 */
	C3_xlargeConnector()
	{
