...
/**
 * This is the item provider adapter for a {@link cloudmonitoring.Supervisorapiconnect} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SupervisorapiconnectItemProvider extends MixinBaseItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SupervisorapiconnectItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns Supervisorapiconnect.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Supervisorapiconnect"));
	}
	...
	public String getText(Object object) {
		String label = ((Supervisorapiconnect)object).getUsername();
		return label == null || label.length() == 0 ?
			getString("_UI_Supervisorapiconnect_type") :
			getString("_UI_Supervisorapiconnect_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Supervisorapiconnect.class)) {
