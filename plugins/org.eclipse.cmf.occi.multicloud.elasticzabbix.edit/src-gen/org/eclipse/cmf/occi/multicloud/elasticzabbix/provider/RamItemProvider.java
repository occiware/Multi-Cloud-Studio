...
/**
 * This is the item provider adapter for a {@link org.eclipse.cmf.occi.multicloud.elasticzabbix.Ram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RamItemProvider extends MixinBaseItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ram_free_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ram_free_feature", "_UI_Ram_type"),
				 ElasticzabbixPackage.Literals.RAM__FREE,
				 true,
				 false,
				 false,
	...
	protected void addSwapPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ram_swap_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ram_swap_feature", "_UI_Ram_type"),
				 ElasticzabbixPackage.Literals.RAM__SWAP,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ElasticzabbixPackage.Literals.RAM__RAM_USED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		Double labelValue = ((Ram)object).getFree();
