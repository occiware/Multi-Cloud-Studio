 ...
 * - title: 
 */
public class GeneralpurposeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.GeneralpurposeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(GeneralpurposeConnector.class);

	// Start of user code Generalpurposeconnector_constructor
	/**
	 * Constructs a generalpurpose connector.
	 */
