 ...
 * - title: 
 */
public class R4_4xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.R4_4xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(R4_4xlargeConnector.class);

	// Start of user code R4_4xlargeconnector_constructor
	/**
	 * Constructs a r4_4xlarge connector.
	 */
	R4_4xlargeConnector()
	{
