...
import awsregions.impl.Ap_south_1Impl;
 ...
 * - title: 
 */
public class Ap_south_1Connector extends Ap_south_1Impl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(Ap_south_1Connector.class);

	// Start of user code Ap_south_1connector_constructor
	/**
	 * Constructs a ap_south_1 connector.
	 */
	Ap_south_1Connector()
	{
