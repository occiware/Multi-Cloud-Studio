 ...
 * - title: 
 */
public class I3_metalConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.I3_metalImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(I3_metalConnector.class);

	// Start of user code I3_metalconnector_constructor
	/**
	 * Constructs a i3_metal connector.
	 */
	I3_metalConnector()
	{
