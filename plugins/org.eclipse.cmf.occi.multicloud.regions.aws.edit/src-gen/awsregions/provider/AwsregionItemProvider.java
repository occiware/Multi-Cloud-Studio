...
import org.eclipse.cmf.occi.multicloud.regions.provider.RegionItemProvider;
...
/**
 * This is the item provider adapter for a {@link awsregions.Awsregion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AwsregionItemProvider extends RegionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AwsregionItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Awsregion"));
	}
	...
	public String getText(Object object) {
		String label = ((Awsregion)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_Awsregion_type") :
			getString("_UI_Awsregion_type") + " " + label;
	}
