 ...
 * - title: 
 */
public class P3_8xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.P3_8xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(P3_8xlargeConnector.class);

	// Start of user code P3_8xlargeconnector_constructor
	/**
	 * Constructs a p3_8xlarge connector.
	 */
	P3_8xlargeConnector()
	{
