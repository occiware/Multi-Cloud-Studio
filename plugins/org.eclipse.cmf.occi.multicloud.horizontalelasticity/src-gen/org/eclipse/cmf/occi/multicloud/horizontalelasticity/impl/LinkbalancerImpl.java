...
public class LinkbalancerImpl extends LinkImpl implements Linkbalancer {
	 ...
	 * @ordered
	 */
	protected static final String TARGET_CONSTRAINT_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION = "self.target.oclIsKindOf(horizontalelasticity::Loadbalancer)";
	...
	public boolean targetConstraint(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			HorizontalelasticityValidator.validate
				(HorizontalelasticityPackage.Literals.LINKBALANCER,
				 this,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 HorizontalelasticityPackage.Literals.LINKBALANCER___TARGET_CONSTRAINT__DIAGNOSTICCHAIN_MAP,
				 TARGET_CONSTRAINT_DIAGNOSTIC_CHAIN_MAP__EEXPRESSION,
				 Diagnostic.ERROR,
				 HorizontalelasticityValidator.DIAGNOSTIC_SOURCE,
				 HorizontalelasticityValidator.LINKBALANCER__TARGET_CONSTRAINT);
	}
