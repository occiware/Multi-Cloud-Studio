 ...
 * - title: 
 */
public class M5_xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.M5_xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(M5_xlargeConnector.class);

	// Start of user code M5_xlargeconnector_constructor
	/**
	 * Constructs a m5_xlarge connector.
	 */
	M5_xlargeConnector()
	{
