 ...
 * - title: 
 */
public class M1_largeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.M1_largeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(M1_largeConnector.class);

	// Start of user code M1_largeconnector_constructor
	/**
	 * Constructs a m1_large connector.
	 */
	M1_largeConnector()
	{
