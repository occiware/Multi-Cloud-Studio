 ...
 * - title: 
 */
public class R3_xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.R3_xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(R3_xlargeConnector.class);

	// Start of user code R3_xlargeconnector_constructor
	/**
	 * Constructs a r3_xlarge connector.
	 */
	R3_xlargeConnector()
	{
