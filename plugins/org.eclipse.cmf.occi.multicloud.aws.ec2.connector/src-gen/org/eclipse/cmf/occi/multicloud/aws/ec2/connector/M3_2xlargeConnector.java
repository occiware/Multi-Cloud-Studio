 ...
 * - title: 
 */
public class M3_2xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.M3_2xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(M3_2xlargeConnector.class);

	// Start of user code M3_2xlargeconnector_constructor
	/**
	 * Constructs a m3_2xlarge connector.
	 */
	M3_2xlargeConnector()
	{
