 ...
 * - title: 
 */
public class T2_2xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.T2_2xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(T2_2xlargeConnector.class);

	// Start of user code T2_2xlargeconnector_constructor
	/**
	 * Constructs a t2_2xlarge connector.
	 */
	T2_2xlargeConnector()
	{
