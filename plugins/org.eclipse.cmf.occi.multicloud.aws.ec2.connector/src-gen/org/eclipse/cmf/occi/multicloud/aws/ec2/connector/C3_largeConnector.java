 ...
 * - title: 
 */
public class C3_largeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.C3_largeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(C3_largeConnector.class);

	// Start of user code C3_largeconnector_constructor
	/**
	 * Constructs a c3_large connector.
	 */
	C3_largeConnector()
	{
