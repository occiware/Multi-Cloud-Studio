 ...
 * - title: 
 */
public class EuropeConnector extends org.eclipse.cmf.occi.multicloud.regions.impl.EuropeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(EuropeConnector.class);

	// Start of user code Europeconnector_constructor
	/**
	 * Constructs a europe connector.
	 */
	EuropeConnector()
	{
