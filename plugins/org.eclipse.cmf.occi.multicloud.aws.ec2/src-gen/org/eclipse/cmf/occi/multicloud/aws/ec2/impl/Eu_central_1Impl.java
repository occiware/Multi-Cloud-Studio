...
import org.eclipse.cmf.occi.multicloud.aws.ec2.Eu_central_1;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.Eu_central_1Impl#getCountry <em>Country</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.Eu_central_1Impl#getRegionId <em>Region Id</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.Eu_central_1Impl#getCity <em>City</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.Eu_central_1Impl#getRegionName <em>Region Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Eu_central_1Impl extends MixinBaseImpl implements Eu_central_1 {
	/**
	...
	protected EClass eStaticClass() {
		return Ec2Package.eINSTANCE.getEu_central_1();
	}
	...
	public void setCountry(String newCountry) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.EU_CENTRAL_1__COUNTRY, oldCountry, country));
	}
	...
	public void setRegionId(String newRegionId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.EU_CENTRAL_1__REGION_ID, oldRegionId, regionId));
	}
	...
	public void setCity(String newCity) {
		...
		city = newCity;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.EU_CENTRAL_1__CITY, oldCity, city));
	}
	...
	public void setRegionName(String newRegionName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.EU_CENTRAL_1__REGION_NAME, oldRegionName, regionName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ec2Package.EU_CENTRAL_1__COUNTRY:
				return getCountry();
			case Ec2Package.EU_CENTRAL_1__REGION_ID:
				return getRegionId();
			case Ec2Package.EU_CENTRAL_1__CITY:
				return getCity();
			case Ec2Package.EU_CENTRAL_1__REGION_NAME:
