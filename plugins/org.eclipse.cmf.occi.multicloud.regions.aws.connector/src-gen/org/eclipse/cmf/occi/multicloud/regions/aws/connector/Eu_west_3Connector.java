...
import awsregions.impl.Eu_west_3Impl;
 ...
 * - title: 
 */
public class Eu_west_3Connector extends Eu_west_3Impl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(Eu_west_3Connector.class);

	// Start of user code Eu_west_3connector_constructor
	/**
	 * Constructs a eu_west_3 connector.
	 */
	Eu_west_3Connector()
	{
