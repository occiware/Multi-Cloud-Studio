...
public class DatastoreHelper {
	...
	public static Datastore findDatastoreForName(final Datacenter datacenter, final String name) {
		...
		try {
			datastore = (Datastore) new InventoryNavigator(datacenter).searchManagedEntity(DATASTORE, name);
	...
	public static Datastore findDatastoreForName(final Folder folder, final String name) {
		Datastore datastore = null;
		try {
			datastore = (Datastore) new InventoryNavigator(folder).searchManagedEntity(DATASTORE, name);
