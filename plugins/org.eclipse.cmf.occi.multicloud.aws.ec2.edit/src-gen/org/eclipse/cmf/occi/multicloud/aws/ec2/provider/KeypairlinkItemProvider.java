...
/**
 * This is the item provider adapter for a {@link org.eclipse.cmf.occi.multicloud.aws.ec2.Keypairlink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class KeypairlinkItemProvider extends LinkItemProvider {
	/**
	 ...
	 * @generated
	 */
	public KeypairlinkItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Keypairlink"));
	}
	...
	public String getText(Object object) {
		String label = ((Keypairlink)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_Keypairlink_type") :
			getString("_UI_Keypairlink_type") + " " + label;
	}
