 ...
 * - title: 
 */
public class C4_4xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.C4_4xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(C4_4xlargeConnector.class);

	// Start of user code C4_4xlargeconnector_constructor
	/**
	 * Constructs a c4_4xlarge connector.
	 */
	C4_4xlargeConnector()
	{
