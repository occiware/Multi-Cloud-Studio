...
import org.eclipse.cmf.occi.multicloud.aws.ec2.Ippermissions;
...
/**
 * This is the item provider adapter for a {@link org.eclipse.cmf.occi.multicloud.aws.ec2.Ippermissions} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IppermissionsItemProvider extends LinkItemProvider {
	/**
	 ...
	 * @generated
	 */
	public IppermissionsItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ippermissions_ipRange_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ippermissions_ipRange_feature", "_UI_Ippermissions_type"),
				 Ec2Package.eINSTANCE.getIppermissions_IpRange(),
				 true,
				 false,
				 false,
	...
	protected void addIpProtocolPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ippermissions_ipProtocol_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ippermissions_ipProtocol_feature", "_UI_Ippermissions_type"),
				 Ec2Package.eINSTANCE.getIppermissions_IpProtocol(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addFromPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ippermissions_fromPort_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ippermissions_fromPort_feature", "_UI_Ippermissions_type"),
				 Ec2Package.eINSTANCE.getIppermissions_FromPort(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addToPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ippermissions_toPort_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ippermissions_toPort_feature", "_UI_Ippermissions_type"),
				 Ec2Package.eINSTANCE.getIppermissions_ToPort(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns Ippermissions.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Ippermissions"));
	}
	...
	public String getText(Object object) {
		String label = ((Ippermissions)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_Ippermissions_type") :
			getString("_UI_Ippermissions_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Ippermissions.class)) {
			case Ec2Package.IPPERMISSIONS__IP_RANGE:
			case Ec2Package.IPPERMISSIONS__IP_PROTOCOL:
			case Ec2Package.IPPERMISSIONS__FROM_PORT:
			case Ec2Package.IPPERMISSIONS__TO_PORT:
