 ...
 * - title: 
 */
public class G3_8xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.G3_8xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(G3_8xlargeConnector.class);

	// Start of user code G3_8xlargeconnector_constructor
	/**
	 * Constructs a g3_8xlarge connector.
	 */
	G3_8xlargeConnector()
	{
