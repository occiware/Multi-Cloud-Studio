 ...
 * - title: 
 */
public class G3_4xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.G3_4xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(G3_4xlargeConnector.class);

	// Start of user code G3_4xlargeconnector_constructor
	/**
	 * Constructs a g3_4xlarge connector.
	 */
	G3_4xlargeConnector()
	{
