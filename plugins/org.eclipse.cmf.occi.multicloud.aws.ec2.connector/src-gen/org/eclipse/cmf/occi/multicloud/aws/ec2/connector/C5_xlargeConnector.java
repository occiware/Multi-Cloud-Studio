 ...
 * - title: 
 */
public class C5_xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.C5_xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(C5_xlargeConnector.class);

	// Start of user code C5_xlargeconnector_constructor
	/**
	 * Constructs a c5_xlarge connector.
	 */
	C5_xlargeConnector()
	{
