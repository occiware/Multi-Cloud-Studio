 ...
 * - title: 
 */
public class M1_mediumConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.M1_mediumImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(M1_mediumConnector.class);

	// Start of user code M1_mediumconnector_constructor
	/**
	 * Constructs a m1_medium connector.
	 */
	M1_mediumConnector()
	{
