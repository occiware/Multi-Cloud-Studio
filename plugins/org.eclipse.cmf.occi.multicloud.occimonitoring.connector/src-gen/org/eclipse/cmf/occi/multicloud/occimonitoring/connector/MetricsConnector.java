 ...
 * - title: 
 */
public class MetricsConnector extends org.eclipse.cmf.occi.multicloud.occimonitoring.impl.MetricsImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(MetricsConnector.class);

	// Start of user code Metricsconnector_constructor
	/**
	 * Constructs a metrics connector.
	 */
	MetricsConnector()
	{
