 ...
 */
public class WindowsConnector extends org.eclipse.cmf.occi.multicloud.vmware.impl.WindowsImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(WindowsConnector.class);

	// Start of user code Windowsconnector_constructor
	/**
	 * Constructs a windows connector.
	 */
	WindowsConnector()
	{
