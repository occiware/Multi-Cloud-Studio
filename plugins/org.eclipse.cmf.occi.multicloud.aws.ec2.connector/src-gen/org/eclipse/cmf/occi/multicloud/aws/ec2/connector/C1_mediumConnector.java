 ...
 * - title: 
 */
public class C1_mediumConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.C1_mediumImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(C1_mediumConnector.class);

	// Start of user code C1_mediumconnector_constructor
	/**
	 * Constructs a c1_medium connector.
	 */
	C1_mediumConnector()
	{
