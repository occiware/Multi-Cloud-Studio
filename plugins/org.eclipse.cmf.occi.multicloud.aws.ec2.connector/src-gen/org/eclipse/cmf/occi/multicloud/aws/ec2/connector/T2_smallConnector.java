 ...
 * - title: 
 */
public class T2_smallConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.T2_smallImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(T2_smallConnector.class);

	// Start of user code T2_smallconnector_constructor
	/**
	 * Constructs a t2_small connector.
	 */
	T2_smallConnector()
	{
