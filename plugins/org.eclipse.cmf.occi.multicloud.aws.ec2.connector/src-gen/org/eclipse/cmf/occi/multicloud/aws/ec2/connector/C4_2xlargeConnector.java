 ...
 * - title: 
 */
public class C4_2xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.C4_2xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(C4_2xlargeConnector.class);

	// Start of user code C4_2xlargeconnector_constructor
	/**
	 * Constructs a c4_2xlarge connector.
	 */
	C4_2xlargeConnector()
	{
