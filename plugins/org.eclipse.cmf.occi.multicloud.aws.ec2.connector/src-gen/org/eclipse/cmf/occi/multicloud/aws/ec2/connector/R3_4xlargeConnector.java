 ...
 * - title: 
 */
public class R3_4xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.R3_4xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(R3_4xlargeConnector.class);

	// Start of user code R3_4xlargeconnector_constructor
	/**
	 * Constructs a r3_4xlarge connector.
	 */
	R3_4xlargeConnector()
	{
