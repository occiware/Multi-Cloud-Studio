...
public class Ap_south_east2Connector extends Ap_south_east2Impl
{
	 ...
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(Ap_south_east2Connector.class);

	// Start of user code Ap_south_east2connector_constructor
	/**
	 * Constructs a ap_south_east2 connector.
	 */
	Ap_south_east2Connector()
	{
