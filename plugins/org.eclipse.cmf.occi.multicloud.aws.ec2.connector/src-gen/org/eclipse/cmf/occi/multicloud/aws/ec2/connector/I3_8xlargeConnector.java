 ...
 * - title: 
 */
public class I3_8xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.I3_8xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(I3_8xlargeConnector.class);

	// Start of user code I3_8xlargeconnector_constructor
	/**
	 * Constructs a i3_8xlarge connector.
	 */
	I3_8xlargeConnector()
	{
