 ...
 * - title: 
 */
public class StepsConnector extends org.eclipse.cmf.occi.multicloud.horizontalelasticity.impl.StepsImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(StepsConnector.class);

	// Start of user code Stepsconnector_constructor
	/**
	 * Constructs a steps connector.
	 */
	StepsConnector()
	{
