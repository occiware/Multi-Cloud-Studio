 ...
 * - title: 
 */
public class I3_4xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.I3_4xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(I3_4xlargeConnector.class);

	// Start of user code I3_4xlargeconnector_constructor
	/**
	 * Constructs a i3_4xlarge connector.
	 */
	I3_4xlargeConnector()
	{
