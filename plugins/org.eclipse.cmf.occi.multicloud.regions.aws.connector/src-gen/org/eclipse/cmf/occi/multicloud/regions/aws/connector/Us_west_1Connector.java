...
import awsregions.impl.Us_west_1Impl;
 ...
 * - title: 
 */
public class Us_west_1Connector extends Us_west_1Impl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(Us_west_1Connector.class);

	// Start of user code Us_west_1connector_constructor
	/**
	 * Constructs a us_west_1 connector.
	 */
	Us_west_1Connector()
	{
