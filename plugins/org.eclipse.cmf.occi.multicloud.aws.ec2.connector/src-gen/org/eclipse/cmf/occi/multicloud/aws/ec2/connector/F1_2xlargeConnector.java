 ...
 * - title: 
 */
public class F1_2xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.F1_2xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(F1_2xlargeConnector.class);

	// Start of user code F1_2xlargeconnector_constructor
	/**
	 * Constructs a f1_2xlarge connector.
	 */
	F1_2xlargeConnector()
	{
