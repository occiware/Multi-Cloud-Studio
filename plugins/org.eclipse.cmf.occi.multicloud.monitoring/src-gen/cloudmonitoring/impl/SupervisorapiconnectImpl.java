 ...
 * </p>
 * <ul>
 *   <li>{@link cloudmonitoring.impl.SupervisorapiconnectImpl#getUsername <em>Username</em>}</li>
 *   <li>{@link cloudmonitoring.impl.SupervisorapiconnectImpl#getPassword <em>Password</em>}</li>
 *   <li>{@link cloudmonitoring.impl.SupervisorapiconnectImpl#getHttpApiAddress <em>Http Api Address</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SupervisorapiconnectImpl extends MixinBaseImpl implements Supervisorapiconnect {
	...
	protected EClass eStaticClass() {
		return CloudmonitoringPackage.Literals.SUPERVISORAPICONNECT;
	}
	...
	public void setUsername(String newUsername) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CloudmonitoringPackage.SUPERVISORAPICONNECT__USERNAME, oldUsername, username));
	}
	...
	public void setPassword(String newPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CloudmonitoringPackage.SUPERVISORAPICONNECT__PASSWORD, oldPassword, password));
	}
	...
	public void setHttpApiAddress(String newHttpApiAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CloudmonitoringPackage.SUPERVISORAPICONNECT__HTTP_API_ADDRESS, oldHttpApiAddress, httpApiAddress));
	}
	...
	public boolean appliesConstraint(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, CloudmonitoringTables.STR_Supervisorapiconnect_c_c_appliesConstraint);
		...
		if (le) {
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, CloudmonitoringTables.STR_Supervisorapiconnect_c_c_appliesConstraint, this, (Object)null, diagnostics, context, (Object)null, severity_0, result, CloudmonitoringTables.INT_0).booleanValue();
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CloudmonitoringPackage.SUPERVISORAPICONNECT__USERNAME:
				return getUsername();
			case CloudmonitoringPackage.SUPERVISORAPICONNECT__PASSWORD:
				return getPassword();
			case CloudmonitoringPackage.SUPERVISORAPICONNECT__HTTP_API_ADDRESS:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case CloudmonitoringPackage.SUPERVISORAPICONNECT___APPLIES_CONSTRAINT__DIAGNOSTICCHAIN_MAP:
