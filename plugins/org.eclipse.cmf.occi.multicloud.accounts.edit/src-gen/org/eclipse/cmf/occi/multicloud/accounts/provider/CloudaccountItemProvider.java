...
/**
 * This is the item provider adapter for a {@link org.eclipse.cmf.occi.multicloud.accounts.Cloudaccount} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CloudaccountItemProvider extends ResourceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CloudaccountItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Cloudaccount"));
	}
	...
	public String getText(Object object) {
		String label = ((Cloudaccount)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_Cloudaccount_type") :
			getString("_UI_Cloudaccount_type") + " " + label;
	}
