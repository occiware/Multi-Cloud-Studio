 ...
 * - title: 
 */
public class M5_2xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.M5_2xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(M5_2xlargeConnector.class);

	// Start of user code M5_2xlargeconnector_constructor
	/**
	 * Constructs a m5_2xlarge connector.
	 */
	M5_2xlargeConnector()
	{
