...
import cloudmonitoring.impl.MainmetricImpl;
 ...
 * - title: 
 */
public class MainmetricConnector extends MainmetricImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(MainmetricConnector.class);

	// Start of user code Mainmetricconnector_constructor
	/**
	 * Constructs a mainmetric connector.
	 */
	MainmetricConnector()
	{
