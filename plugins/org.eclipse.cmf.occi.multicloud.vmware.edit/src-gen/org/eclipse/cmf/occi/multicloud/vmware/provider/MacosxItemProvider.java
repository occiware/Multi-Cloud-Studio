...
public class MacosxItemProvider extends MixinBaseItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Macosx_guestid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Macosx_guestid_feature", "_UI_Macosx_type"),
				 VmwarePackage.Literals.MACOSX__GUESTID,
				 true,
				 false,
				 false,
	...
	protected void addDatastoreisopathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Macosx_datastoreisopath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Macosx_datastoreisopath_feature", "_UI_Macosx_type"),
				 VmwarePackage.Literals.MACOSX__DATASTOREISOPATH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		GuestOsIdentifiers labelValue = ((Macosx)object).getGuestid();
