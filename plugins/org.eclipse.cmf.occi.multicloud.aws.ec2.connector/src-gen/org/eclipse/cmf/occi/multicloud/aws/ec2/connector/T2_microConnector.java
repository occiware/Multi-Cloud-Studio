 ...
 * - title: 
 */
public class T2_microConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.T2_microImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(T2_microConnector.class);

	// Start of user code T2_microconnector_constructor
	/**
	 * Constructs a t2_micro connector.
	 */
	T2_microConnector()
	{
