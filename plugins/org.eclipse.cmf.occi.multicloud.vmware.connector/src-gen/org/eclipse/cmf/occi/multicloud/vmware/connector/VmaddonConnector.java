 ...
 */
public class VmaddonConnector extends org.eclipse.cmf.occi.multicloud.vmware.impl.VmaddonImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(VmaddonConnector.class);

	// Start of user code Vmaddonconnector_constructor
	/**
	 * Constructs a vmaddon connector.
	 */
	VmaddonConnector()
	{
