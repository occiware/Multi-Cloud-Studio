 ...
 * - title: 
 */
public class I2_xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.I2_xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(I2_xlargeConnector.class);

	// Start of user code I2_xlargeconnector_constructor
	/**
	 * Constructs a i2_xlarge connector.
	 */
	I2_xlargeConnector()
	{
