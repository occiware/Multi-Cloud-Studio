 ...
 * - title: 
 */
public class R3_8xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.R3_8xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(R3_8xlargeConnector.class);

	// Start of user code R3_8xlargeconnector_constructor
	/**
	 * Constructs a r3_8xlarge connector.
	 */
	R3_8xlargeConnector()
	{
