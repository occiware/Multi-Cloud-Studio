...
/**
 * This is the item provider adapter for a {@link org.eclipse.cmf.occi.multicloud.horizontalelasticity.Linkbalancer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkbalancerItemProvider extends LinkItemProvider {
	/**
	 ...
	 * @generated
	 */
	public LinkbalancerItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Linkbalancer"));
	}
	...
	public String getText(Object object) {
		String label = ((Linkbalancer)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_Linkbalancer_type") :
			getString("_UI_Linkbalancer_type") + " " + label;
	}
