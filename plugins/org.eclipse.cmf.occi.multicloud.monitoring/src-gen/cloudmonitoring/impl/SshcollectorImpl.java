 ...
 * </p>
 * <ul>
 *   <li>{@link cloudmonitoring.impl.SshcollectorImpl#getLabel <em>Label</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SshcollectorImpl extends CollectorImpl implements Sshcollector {
	...
	protected EClass eStaticClass() {
		return CloudmonitoringPackage.Literals.SSHCOLLECTOR;
	}
	...
	public void setLabel(String newLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CloudmonitoringPackage.SSHCOLLECTOR__LABEL, oldLabel, label));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CloudmonitoringPackage.SSHCOLLECTOR__LABEL:
				return getLabel();
		}
