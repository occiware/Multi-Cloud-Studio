 ...
 * - title: 
 */
public class I3_2xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.I3_2xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(I3_2xlargeConnector.class);

	// Start of user code I3_2xlargeconnector_constructor
	/**
	 * Constructs a i3_2xlarge connector.
	 */
	I3_2xlargeConnector()
	{
