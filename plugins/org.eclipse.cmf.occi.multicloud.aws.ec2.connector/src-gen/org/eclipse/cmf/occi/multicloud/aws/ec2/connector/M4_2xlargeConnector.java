 ...
 * - title: 
 */
public class M4_2xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.M4_2xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(M4_2xlargeConnector.class);

	// Start of user code M4_2xlargeconnector_constructor
	/**
	 * Constructs a m4_2xlarge connector.
	 */
	M4_2xlargeConnector()
	{
