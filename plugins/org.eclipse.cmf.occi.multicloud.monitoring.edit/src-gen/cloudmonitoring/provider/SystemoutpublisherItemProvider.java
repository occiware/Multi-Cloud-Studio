...
/**
 * This is the item provider adapter for a {@link cloudmonitoring.Systemoutpublisher} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SystemoutpublisherItemProvider extends MixinBaseItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SystemoutpublisherItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns Systemoutpublisher.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Systemoutpublisher"));
	}
	...
	public String getText(Object object) {
		MonitorState labelValue = ((Systemoutpublisher)object).getPublisherState();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_Systemoutpublisher_type") :
			getString("_UI_Systemoutpublisher_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Systemoutpublisher.class)) {
