...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>X1e 16xlarge</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.X1e_16xlargeImpl#getOcciComputeMemory <em>Occi Compute Memory</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.X1e_16xlargeImpl#getInstanceType <em>Instance Type</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.X1e_16xlargeImpl#getOcciComputeCores <em>Occi Compute Cores</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.X1e_16xlargeImpl#getOcciComputeEphemeralStorageSize <em>Occi Compute Ephemeral Storage Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class X1e_16xlargeImpl extends MemoryoptimizedImpl implements X1e_16xlarge {
	/**
	 ...
	 * @ordered
	 */
	protected static final String INSTANCE_TYPE_EDEFAULT = "x1e.16xlarge";
	 ...
	 * @ordered
	 */
	protected static final Float OCCI_COMPUTE_EPHEMERAL_STORAGE_SIZE_EDEFAULT = new Float(1920.0F);
	...
	protected EClass eStaticClass() {
		return Ec2Package.eINSTANCE.getX1e_16xlarge();
	}
	...
	public void setOcciComputeMemory(Float newOcciComputeMemory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.X1E_16XLARGE__OCCI_COMPUTE_MEMORY, oldOcciComputeMemory, occiComputeMemory));
	}
	...
	public void setInstanceType(String newInstanceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.X1E_16XLARGE__INSTANCE_TYPE, oldInstanceType, instanceType));
	}
	...
	public void setOcciComputeCores(Integer newOcciComputeCores) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.X1E_16XLARGE__OCCI_COMPUTE_CORES, oldOcciComputeCores, occiComputeCores));
	}
	...
	public void setOcciComputeEphemeralStorageSize(Float newOcciComputeEphemeralStorageSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.X1E_16XLARGE__OCCI_COMPUTE_EPHEMERAL_STORAGE_SIZE, oldOcciComputeEphemeralStorageSize, occiComputeEphemeralStorageSize));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ec2Package.X1E_16XLARGE__OCCI_COMPUTE_MEMORY:
				return getOcciComputeMemory();
			case Ec2Package.X1E_16XLARGE__INSTANCE_TYPE:
				return getInstanceType();
			case Ec2Package.X1E_16XLARGE__OCCI_COMPUTE_CORES:
				return getOcciComputeCores();
			case Ec2Package.X1E_16XLARGE__OCCI_COMPUTE_EPHEMERAL_STORAGE_SIZE:
