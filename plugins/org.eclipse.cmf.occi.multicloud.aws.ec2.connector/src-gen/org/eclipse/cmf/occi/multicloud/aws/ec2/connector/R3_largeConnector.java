 ...
 * - title: 
 */
public class R3_largeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.R3_largeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(R3_largeConnector.class);

	// Start of user code R3_largeconnector_constructor
	/**
	 * Constructs a r3_large connector.
	 */
	R3_largeConnector()
	{
