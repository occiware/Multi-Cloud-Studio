...
public class ElasticlinkImpl extends LinkImpl implements Elasticlink {
	...
	protected EClass eStaticClass() {
		return HorizontalelasticityPackage.Literals.ELASTICLINK;
	}
	...
	public boolean targetConstraint(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, HorizontalelasticityTables.STR_Elasticlink_c_c_targetConstraint);
		...
		if (le) {
			...
			final /*@NonInvalid*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, target_0, TYP_horizontalelasticity_c_c_Horizontalgroup).booleanValue();
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, HorizontalelasticityTables.STR_Elasticlink_c_c_targetConstraint, this, (Object)null, diagnostics, context, (Object)null, severity_0, result, HorizontalelasticityTables.INT_0).booleanValue();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case HorizontalelasticityPackage.ELASTICLINK___TARGET_CONSTRAINT__DIAGNOSTICCHAIN_MAP:
