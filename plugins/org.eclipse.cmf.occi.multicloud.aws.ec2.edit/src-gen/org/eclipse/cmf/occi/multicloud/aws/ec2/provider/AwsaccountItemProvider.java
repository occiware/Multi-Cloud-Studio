 ...
 * @generated
 */
public class AwsaccountItemProvider extends CloudaccountItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AwsaccountItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Awsaccount"));
	}
	...
	public String getText(Object object) {
		String label = ((Awsaccount)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_Awsaccount_type") :
			getString("_UI_Awsaccount_type") + " " + label;
	}
