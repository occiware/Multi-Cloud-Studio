...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>T2 micro</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.T2_microImpl#getOcciComputeMemory <em>Occi Compute Memory</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.T2_microImpl#getOcciComputeCores <em>Occi Compute Cores</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.T2_microImpl#getInstanceType <em>Instance Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class T2_microImpl extends GeneralpurposeImpl implements T2_micro {
	/**
	...
	protected EClass eStaticClass() {
		return Ec2Package.eINSTANCE.getT2_micro();
	}
	...
	public void setOcciComputeMemory(Float newOcciComputeMemory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.T2_MICRO__OCCI_COMPUTE_MEMORY, oldOcciComputeMemory, occiComputeMemory));
	}
	...
	public void setOcciComputeCores(Integer newOcciComputeCores) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.T2_MICRO__OCCI_COMPUTE_CORES, oldOcciComputeCores, occiComputeCores));
	}
	...
	public void setInstanceType(String newInstanceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.T2_MICRO__INSTANCE_TYPE, oldInstanceType, instanceType));
	}
