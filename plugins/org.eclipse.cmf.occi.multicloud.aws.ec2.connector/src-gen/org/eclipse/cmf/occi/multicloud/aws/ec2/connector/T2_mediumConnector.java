 ...
 * - title: 
 */
public class T2_mediumConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.T2_mediumImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(T2_mediumConnector.class);

	// Start of user code T2_mediumconnector_constructor
	/**
	 * Constructs a t2_medium connector.
	 */
	T2_mediumConnector()
	{
