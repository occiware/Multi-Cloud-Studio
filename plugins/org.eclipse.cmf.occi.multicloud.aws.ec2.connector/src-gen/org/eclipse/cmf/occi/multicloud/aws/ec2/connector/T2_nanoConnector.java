 ...
 * - title: 
 */
public class T2_nanoConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.T2_nanoImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(T2_nanoConnector.class);

	// Start of user code T2_nanoconnector_constructor
	/**
	 * Constructs a t2_nano connector.
	 */
	T2_nanoConnector()
	{
