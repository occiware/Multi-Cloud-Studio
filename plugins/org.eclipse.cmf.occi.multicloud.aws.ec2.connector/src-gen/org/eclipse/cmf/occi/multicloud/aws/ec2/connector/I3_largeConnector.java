 ...
 * - title: 
 */
public class I3_largeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.I3_largeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(I3_largeConnector.class);

	// Start of user code I3_largeconnector_constructor
	/**
	 * Constructs a i3_large connector.
	 */
	I3_largeConnector()
	{
