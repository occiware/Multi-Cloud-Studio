 ...
 * - title: 
 */
public class M2_4xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.M2_4xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(M2_4xlargeConnector.class);

	// Start of user code M2_4xlargeconnector_constructor
	/**
	 * Constructs a m2_4xlarge connector.
	 */
	M2_4xlargeConnector()
	{
