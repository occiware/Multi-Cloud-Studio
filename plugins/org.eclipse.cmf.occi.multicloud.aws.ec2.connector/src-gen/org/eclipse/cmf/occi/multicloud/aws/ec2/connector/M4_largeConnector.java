 ...
 * - title: 
 */
public class M4_largeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.M4_largeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(M4_largeConnector.class);

	// Start of user code M4_largeconnector_constructor
	/**
	 * Constructs a m4_large connector.
	 */
	M4_largeConnector()
	{
