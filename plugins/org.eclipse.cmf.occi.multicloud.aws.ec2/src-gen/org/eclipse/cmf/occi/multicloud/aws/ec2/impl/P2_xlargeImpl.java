...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>P2 xlarge</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.P2_xlargeImpl#getOcciComputeMemory <em>Occi Compute Memory</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.P2_xlargeImpl#getInstanceType <em>Instance Type</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.P2_xlargeImpl#getOcciComputeCores <em>Occi Compute Cores</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.P2_xlargeImpl#getGpus <em>Gpus</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.P2_xlargeImpl#getGpuMemory <em>Gpu Memory</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.P2_xlargeImpl#getGpuP2P <em>Gpu P2P</em>}</li>
 * </ul>
 *
 * @generated
 */
public class P2_xlargeImpl extends AcceleratedcomputingImpl implements P2_xlarge {
	/**
	 ...
	 * @ordered
	 */
	protected static final String INSTANCE_TYPE_EDEFAULT = "p2.xlarge";
	 ...
	 * @ordered
	 */
	protected static final Float GPU_MEMORY_EDEFAULT = new Float(12.0F);
	...
	protected EClass eStaticClass() {
		return Ec2Package.eINSTANCE.getP2_xlarge();
	}
	...
	public void setOcciComputeMemory(Float newOcciComputeMemory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.P2_XLARGE__OCCI_COMPUTE_MEMORY, oldOcciComputeMemory, occiComputeMemory));
	}
	...
	public void setInstanceType(String newInstanceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.P2_XLARGE__INSTANCE_TYPE, oldInstanceType, instanceType));
	}
	...
	public void setOcciComputeCores(Integer newOcciComputeCores) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.P2_XLARGE__OCCI_COMPUTE_CORES, oldOcciComputeCores, occiComputeCores));
	}
	...
	public void setGpus(Integer newGpus) {
		...
		gpus = newGpus;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.P2_XLARGE__GPUS, oldGpus, gpus));
	}
	...
	public void setGpuMemory(Float newGpuMemory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.P2_XLARGE__GPU_MEMORY, oldGpuMemory, gpuMemory));
	}
	...
	public void setGpuP2P(String newGpuP2P) {
		...
		gpuP2P = newGpuP2P;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.P2_XLARGE__GPU_P2P, oldGpuP2P, gpuP2P));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ec2Package.P2_XLARGE__OCCI_COMPUTE_MEMORY:
				return getOcciComputeMemory();
			case Ec2Package.P2_XLARGE__INSTANCE_TYPE:
				return getInstanceType();
			case Ec2Package.P2_XLARGE__OCCI_COMPUTE_CORES:
				return getOcciComputeCores();
			case Ec2Package.P2_XLARGE__GPUS:
				return getGpus();
			case Ec2Package.P2_XLARGE__GPU_MEMORY:
				return getGpuMemory();
			case Ec2Package.P2_XLARGE__GPU_P2P:
				return getGpuP2P();
		}
