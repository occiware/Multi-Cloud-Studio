 ...
 * - title: 
 */
public class R4_8xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.R4_8xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(R4_8xlargeConnector.class);

	// Start of user code R4_8xlargeconnector_constructor
	/**
	 * Constructs a r4_8xlarge connector.
	 */
	R4_8xlargeConnector()
	{
