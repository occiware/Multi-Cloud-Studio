 ...
 * - title: 
 */
public class R3_2xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.R3_2xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(R3_2xlargeConnector.class);

	// Start of user code R3_2xlargeconnector_constructor
	/**
	 * Constructs a r3_2xlarge connector.
	 */
	R3_2xlargeConnector()
	{
