 ...
 * - title: 
 */
public class T2_xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.T2_xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(T2_xlargeConnector.class);

	// Start of user code T2_xlargeconnector_constructor
	/**
	 * Constructs a t2_xlarge connector.
	 */
	T2_xlargeConnector()
	{
