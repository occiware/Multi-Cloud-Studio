...
public class CloudaccountlinkImpl extends LinkImpl implements Cloudaccountlink {
	...
	public boolean sourceConstraint(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, AccountsTables.STR_Cloudaccountlink_c_c_sourceConstraint);
		...
		if (le) {
			...
			final /*@NonInvalid*/ boolean result = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, source, TYP_accounts_c_c_Cloudaccount).booleanValue();
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, AccountsTables.STR_Cloudaccountlink_c_c_sourceConstraint, this, (Object)null, diagnostics, context, (Object)null, severity_0, result, AccountsTables.INT_0).booleanValue();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case AccountsPackage.CLOUDACCOUNTLINK___SOURCE_CONSTRAINT__DIAGNOSTICCHAIN_MAP:
