 ...
 * - title: 
 */
public class I3_xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.I3_xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(I3_xlargeConnector.class);

	// Start of user code I3_xlargeconnector_constructor
	/**
	 * Constructs a i3_xlarge connector.
	 */
	I3_xlargeConnector()
	{
