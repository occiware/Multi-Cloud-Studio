 ...
 * - title: 
 */
public class R4_2xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.R4_2xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(R4_2xlargeConnector.class);

	// Start of user code R4_2xlargeconnector_constructor
	/**
	 * Constructs a r4_2xlarge connector.
	 */
	R4_2xlargeConnector()
	{
