 ...
 * - title: 
 */
public class TagsConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.TagsImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(TagsConnector.class);

	// Start of user code Tagsconnector_constructor
	/**
	 * Constructs a tags connector.
	 */
	TagsConnector()
	{
