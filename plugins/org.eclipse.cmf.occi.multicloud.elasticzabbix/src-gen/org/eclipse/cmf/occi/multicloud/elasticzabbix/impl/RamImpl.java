 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.elasticzabbix.impl.RamImpl#getFree <em>Free</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.elasticzabbix.impl.RamImpl#getSwap <em>Swap</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.elasticzabbix.impl.RamImpl#getRamUsed <em>Ram Used</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RamImpl extends MixinBaseImpl implements Ram {
	...
	protected EClass eStaticClass() {
		return ElasticzabbixPackage.Literals.RAM;
	}
	...
	public void setFree(Double newFree) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElasticzabbixPackage.RAM__FREE, oldFree, free));
	}
	...
	public void setSwap(Double newSwap) {
		...
		swap = newSwap;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElasticzabbixPackage.RAM__SWAP, oldSwap, swap));
	}
	...
	public void setRamUsed(Double newRamUsed) {
		...
		ramUsed = newRamUsed;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElasticzabbixPackage.RAM__RAM_USED, oldRamUsed, ramUsed));
	}
	...
	public boolean appliesConstraint(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, ElasticzabbixTables.STR_Ram_c_c_appliesConstraint);
		...
		if (le) {
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, ElasticzabbixTables.STR_Ram_c_c_appliesConstraint, this, (Object)null, diagnostics, context, (Object)null, severity_0, result, ElasticzabbixTables.INT_0).booleanValue();
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ElasticzabbixPackage.RAM__FREE:
				return getFree();
			case ElasticzabbixPackage.RAM__SWAP:
				return getSwap();
			case ElasticzabbixPackage.RAM__RAM_USED:
				return getRamUsed();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ElasticzabbixPackage.RAM___APPLIES_CONSTRAINT__DIAGNOSTICCHAIN_MAP:
