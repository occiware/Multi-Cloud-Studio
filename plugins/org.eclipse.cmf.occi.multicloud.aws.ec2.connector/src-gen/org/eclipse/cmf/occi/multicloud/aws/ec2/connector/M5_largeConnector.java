 ...
 * - title: 
 */
public class M5_largeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.M5_largeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(M5_largeConnector.class);

	// Start of user code M5_largeconnector_constructor
	/**
	 * Constructs a m5_large connector.
	 */
	M5_largeConnector()
	{
