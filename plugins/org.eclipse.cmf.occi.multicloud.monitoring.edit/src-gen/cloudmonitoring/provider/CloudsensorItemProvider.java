...
/**
 * This is the item provider adapter for a {@link cloudmonitoring.Cloudsensor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CloudsensorItemProvider extends SensorItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CloudsensorItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Cloudsensor"));
	}
	...
	public String getText(Object object) {
		String label = ((Cloudsensor)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_Cloudsensor_type") :
			getString("_UI_Cloudsensor_type") + " " + label;
	}
