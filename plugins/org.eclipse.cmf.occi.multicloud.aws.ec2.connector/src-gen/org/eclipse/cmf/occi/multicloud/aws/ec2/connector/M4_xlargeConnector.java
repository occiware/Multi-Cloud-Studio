 ...
 * - title: 
 */
public class M4_xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.M4_xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(M4_xlargeConnector.class);

	// Start of user code M4_xlargeconnector_constructor
	/**
	 * Constructs a m4_xlarge connector.
	 */
	M4_xlargeConnector()
	{
