 ...
 * - title: 
 */
public class P2_8xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.P2_8xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(P2_8xlargeConnector.class);

	// Start of user code P2_8xlargeconnector_constructor
	/**
	 * Constructs a p2_8xlarge connector.
	 */
	P2_8xlargeConnector()
	{
