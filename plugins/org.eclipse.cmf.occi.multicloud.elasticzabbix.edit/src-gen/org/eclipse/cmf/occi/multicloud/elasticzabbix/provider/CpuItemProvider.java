...
/**
 * This is the item provider adapter for a {@link org.eclipse.cmf.occi.multicloud.elasticzabbix.Cpu} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CpuItemProvider extends MixinBaseItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ElasticzabbixPackage.Literals.CPU__LOAD_AVG,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ElasticzabbixPackage.Literals.CPU__CPU_USED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		Double labelValue = ((Cpu)object).getLoadAvg();
