...
import cloudmonitoring.impl.InputoutputImpl;
 ...
 * - title: 
 */
public class InputoutputConnector extends InputoutputImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(InputoutputConnector.class);

	// Start of user code Inputoutputconnector_constructor
	/**
	 * Constructs a inputoutput connector.
	 */
	InputoutputConnector()
	{
