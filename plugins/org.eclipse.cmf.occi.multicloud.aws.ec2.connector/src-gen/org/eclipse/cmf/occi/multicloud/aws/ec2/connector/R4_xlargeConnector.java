 ...
 * - title: 
 */
public class R4_xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.R4_xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(R4_xlargeConnector.class);

	// Start of user code R4_xlargeconnector_constructor
	/**
	 * Constructs a r4_xlarge connector.
	 */
	R4_xlargeConnector()
	{
