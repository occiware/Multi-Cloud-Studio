 ...
 * - title: 
 */
public class M5_4xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.M5_4xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(M5_4xlargeConnector.class);

	// Start of user code M5_4xlargeconnector_constructor
	/**
	 * Constructs a m5_4xlarge connector.
	 */
	M5_4xlargeConnector()
	{
