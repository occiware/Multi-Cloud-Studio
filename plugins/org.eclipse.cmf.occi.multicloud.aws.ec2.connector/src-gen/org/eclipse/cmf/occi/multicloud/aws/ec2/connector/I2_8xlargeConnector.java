 ...
 * - title: 
 */
public class I2_8xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.I2_8xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(I2_8xlargeConnector.class);

	// Start of user code I2_8xlargeconnector_constructor
	/**
	 * Constructs a i2_8xlarge connector.
	 */
	I2_8xlargeConnector()
	{
