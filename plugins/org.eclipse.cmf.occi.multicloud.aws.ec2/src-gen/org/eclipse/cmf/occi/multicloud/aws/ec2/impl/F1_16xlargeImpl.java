...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>F1 16xlarge</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.F1_16xlargeImpl#getOcciComputeMemory <em>Occi Compute Memory</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.F1_16xlargeImpl#getInstanceType <em>Instance Type</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.F1_16xlargeImpl#getOcciComputeCores <em>Occi Compute Cores</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.F1_16xlargeImpl#getFpga <em>Fpga</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.aws.ec2.impl.F1_16xlargeImpl#getOcciComputeEphemeralStorageSize <em>Occi Compute Ephemeral Storage Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class F1_16xlargeImpl extends AcceleratedcomputingImpl implements F1_16xlarge {
	/**
	 ...
	 * @ordered
	 */
	protected static final Float OCCI_COMPUTE_MEMORY_EDEFAULT = new Float(976.0F);
	 ...
	 * @ordered
	 */
	protected static final String INSTANCE_TYPE_EDEFAULT = "f1.16xlarge";
	 ...
	 * @ordered
	 */
	protected static final Integer OCCI_COMPUTE_CORES_EDEFAULT = new Integer(64);
	...
	/**
	 * The default value of the '{@link #getFpga() <em>Fpga</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getFpga()
	 * @generated
	 * @ordered
	 */
	protected static final Integer FPGA_EDEFAULT = new Integer(8);

	/**
	 * The cached value of the '{@link #getFpga() <em>Fpga</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getFpga()
	 * @generated
	 * @ordered
	 */
	protected Integer fpga = FPGA_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final Float OCCI_COMPUTE_EPHEMERAL_STORAGE_SIZE_EDEFAULT = new Float(3760.0F);
	...
	protected EClass eStaticClass() {
		return Ec2Package.eINSTANCE.getF1_16xlarge();
	}
	...
	public void setOcciComputeMemory(Float newOcciComputeMemory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.F1_16XLARGE__OCCI_COMPUTE_MEMORY, oldOcciComputeMemory, occiComputeMemory));
	}
	...
	public void setInstanceType(String newInstanceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.F1_16XLARGE__INSTANCE_TYPE, oldInstanceType, instanceType));
	}
	...
	public void setOcciComputeCores(Integer newOcciComputeCores) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.F1_16XLARGE__OCCI_COMPUTE_CORES, oldOcciComputeCores, occiComputeCores));
	}
	 ...
	 * @generated
	 */
	public void setFpga(Integer newFpga) {
		Integer oldFpga = fpga;
		fpga = newFpga;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.F1_16XLARGE__FPGA, oldFpga, fpga));
	}
	...
	public void setOcciComputeEphemeralStorageSize(Float newOcciComputeEphemeralStorageSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.F1_16XLARGE__OCCI_COMPUTE_EPHEMERAL_STORAGE_SIZE, oldOcciComputeEphemeralStorageSize, occiComputeEphemeralStorageSize));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ec2Package.F1_16XLARGE__OCCI_COMPUTE_MEMORY:
				return getOcciComputeMemory();
			case Ec2Package.F1_16XLARGE__INSTANCE_TYPE:
				return getInstanceType();
			case Ec2Package.F1_16XLARGE__OCCI_COMPUTE_CORES:
				return getOcciComputeCores();
			case Ec2Package.F1_16XLARGE__FPGA:
				return getFpga();
			case Ec2Package.F1_16XLARGE__OCCI_COMPUTE_EPHEMERAL_STORAGE_SIZE:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case Ec2Package.F1_16XLARGE__FPGA:
				return FPGA_EDEFAULT == null ? fpga != null : !FPGA_EDEFAULT.equals(fpga);
			case Ec2Package.F1_16XLARGE__OCCI_COMPUTE_EPHEMERAL_STORAGE_SIZE:
