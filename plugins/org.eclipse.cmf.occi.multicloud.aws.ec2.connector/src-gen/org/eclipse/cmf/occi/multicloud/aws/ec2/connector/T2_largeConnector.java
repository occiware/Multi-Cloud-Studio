 ...
 * - title: 
 */
public class T2_largeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.T2_largeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(T2_largeConnector.class);

	// Start of user code T2_largeconnector_constructor
	/**
	 * Constructs a t2_large connector.
	 */
	T2_largeConnector()
	{
