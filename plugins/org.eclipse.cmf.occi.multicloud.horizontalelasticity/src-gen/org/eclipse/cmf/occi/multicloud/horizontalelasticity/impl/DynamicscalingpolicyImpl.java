 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.horizontalelasticity.impl.DynamicscalingpolicyImpl#getDynamicscalingpolicyCoolDuration <em>Dynamicscalingpolicy Cool Duration</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.horizontalelasticity.impl.DynamicscalingpolicyImpl#getDynamicscalingpolicyIterationWaitTime <em>Dynamicscalingpolicy Iteration Wait Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DynamicscalingpolicyImpl extends ScalingpolicyImpl implements Dynamicscalingpolicy {
	...
	protected EClass eStaticClass() {
		return HorizontalelasticityPackage.Literals.DYNAMICSCALINGPOLICY;
	}
	...
	public void setDynamicscalingpolicyCoolDuration(Integer newDynamicscalingpolicyCoolDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HorizontalelasticityPackage.DYNAMICSCALINGPOLICY__DYNAMICSCALINGPOLICY_COOL_DURATION, oldDynamicscalingpolicyCoolDuration, dynamicscalingpolicyCoolDuration));
	}
	...
	public void setDynamicscalingpolicyIterationWaitTime(Integer newDynamicscalingpolicyIterationWaitTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HorizontalelasticityPackage.DYNAMICSCALINGPOLICY__DYNAMICSCALINGPOLICY_ITERATION_WAIT_TIME, oldDynamicscalingpolicyIterationWaitTime, dynamicscalingpolicyIterationWaitTime));
	}
