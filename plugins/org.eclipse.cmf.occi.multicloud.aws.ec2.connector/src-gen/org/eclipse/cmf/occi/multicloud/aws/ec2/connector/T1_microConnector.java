 ...
 * - title: 
 */
public class T1_microConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.T1_microImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(T1_microConnector.class);

	// Start of user code T1_microconnector_constructor
	/**
	 * Constructs a t1_micro connector.
	 */
	T1_microConnector()
	{
