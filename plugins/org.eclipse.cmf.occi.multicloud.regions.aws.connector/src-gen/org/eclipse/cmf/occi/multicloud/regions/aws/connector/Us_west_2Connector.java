...
import awsregions.impl.Us_west_2Impl;
 ...
 * - title: 
 */
public class Us_west_2Connector extends Us_west_2Impl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(Us_west_2Connector.class);

	// Start of user code Us_west_2connector_constructor
	/**
	 * Constructs a us_west_2 connector.
	 */
	Us_west_2Connector()
	{
