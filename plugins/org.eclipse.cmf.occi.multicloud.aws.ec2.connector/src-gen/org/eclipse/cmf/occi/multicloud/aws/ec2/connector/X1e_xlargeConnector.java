 ...
 * - title: 
 */
public class X1e_xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.X1e_xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(X1e_xlargeConnector.class);

	// Start of user code X1e_xlargeconnector_constructor
	/**
	 * Constructs a x1e_xlarge connector.
	 */
	X1e_xlargeConnector()
	{
