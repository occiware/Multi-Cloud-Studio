 ...
 * - title: 
 */
public class M3_mediumConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.M3_mediumImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(M3_mediumConnector.class);

	// Start of user code M3_mediumconnector_constructor
	/**
	 * Constructs a m3_medium connector.
	 */
	M3_mediumConnector()
	{
