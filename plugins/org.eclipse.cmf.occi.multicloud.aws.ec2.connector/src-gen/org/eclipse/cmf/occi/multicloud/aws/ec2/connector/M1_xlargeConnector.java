 ...
 * - title: 
 */
public class M1_xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.M1_xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(M1_xlargeConnector.class);

	// Start of user code M1_xlargeconnector_constructor
	/**
	 * Constructs a m1_xlarge connector.
	 */
	M1_xlargeConnector()
	{
