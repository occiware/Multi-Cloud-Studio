 ...
 * - title: 
 */
public class C4_8xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.C4_8xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(C4_8xlargeConnector.class);

	// Start of user code C4_8xlargeconnector_constructor
	/**
	 * Constructs a c4_8xlarge connector.
	 */
	C4_8xlargeConnector()
	{
