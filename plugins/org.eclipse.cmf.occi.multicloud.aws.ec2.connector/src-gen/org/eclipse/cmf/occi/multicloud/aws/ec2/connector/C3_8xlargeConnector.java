 ...
 * - title: 
 */
public class C3_8xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.C3_8xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(C3_8xlargeConnector.class);

	// Start of user code C3_8xlargeconnector_constructor
	/**
	 * Constructs a c3_8xlarge connector.
	 */
	C3_8xlargeConnector()
	{
