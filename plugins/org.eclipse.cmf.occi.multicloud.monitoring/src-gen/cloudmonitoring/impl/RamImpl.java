 ...
 *   <li>{@link cloudmonitoring.impl.RamImpl#getUtilization <em>Utilization</em>}</li>
...
public class RamImpl extends MixinBaseImpl implements Ram {
	...
	public void setUtilization(Double newUtilization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CloudmonitoringPackage.RAM__UTILIZATION, oldUtilization, utilization));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Mainmetric.class) {
			switch (derivedFeatureID) {
				...
				case CloudmonitoringPackage.RAM__UTILIZATION: return CloudmonitoringPackage.MAINMETRIC__UTILIZATION;
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Mainmetric.class) {
			switch (baseFeatureID) {
				...
				case CloudmonitoringPackage.MAINMETRIC__UTILIZATION: return CloudmonitoringPackage.RAM__UTILIZATION;
