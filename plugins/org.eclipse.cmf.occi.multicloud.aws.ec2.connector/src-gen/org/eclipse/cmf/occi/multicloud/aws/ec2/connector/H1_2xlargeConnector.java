 ...
 * - title: 
 */
public class H1_2xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.H1_2xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(H1_2xlargeConnector.class);

	// Start of user code H1_2xlargeconnector_constructor
	/**
	 * Constructs a h1_2xlarge connector.
	 */
	H1_2xlargeConnector()
	{
