...
import awsregions.impl.Us_east_2Impl;
 ...
 * - title: 
 */
public class Us_east_2Connector extends Us_east_2Impl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(Us_east_2Connector.class);

	// Start of user code Us_east_2connector_constructor
	/**
	 * Constructs a us_east_2 connector.
	 */
	Us_east_2Connector()
	{
