 ...
 * - title: 
 */
public class P2_xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.P2_xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(P2_xlargeConnector.class);

	// Start of user code P2_xlargeconnector_constructor
	/**
	 * Constructs a p2_xlarge connector.
	 */
	P2_xlargeConnector()
	{
