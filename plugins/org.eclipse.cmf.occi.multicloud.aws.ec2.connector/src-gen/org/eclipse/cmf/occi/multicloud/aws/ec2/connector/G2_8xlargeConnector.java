 ...
 * - title: 
 */
public class G2_8xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.G2_8xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(G2_8xlargeConnector.class);

	// Start of user code G2_8xlargeconnector_constructor
	/**
	 * Constructs a g2_8xlarge connector.
	 */
	G2_8xlargeConnector()
	{
