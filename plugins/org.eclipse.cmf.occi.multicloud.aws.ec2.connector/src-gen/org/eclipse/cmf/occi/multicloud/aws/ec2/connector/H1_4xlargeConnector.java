 ...
 * - title: 
 */
public class H1_4xlargeConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.H1_4xlargeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(H1_4xlargeConnector.class);

	// Start of user code H1_4xlargeconnector_constructor
	/**
	 * Constructs a h1_4xlarge connector.
	 */
	H1_4xlargeConnector()
	{
