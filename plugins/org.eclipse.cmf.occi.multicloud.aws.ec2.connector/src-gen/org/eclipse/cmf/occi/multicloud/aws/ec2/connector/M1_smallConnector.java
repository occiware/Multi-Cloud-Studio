 ...
 * - title: 
 */
public class M1_smallConnector extends org.eclipse.cmf.occi.multicloud.aws.ec2.impl.M1_smallImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(M1_smallConnector.class);

	// Start of user code M1_smallconnector_constructor
	/**
	 * Constructs a m1_small connector.
	 */
	M1_smallConnector()
	{
